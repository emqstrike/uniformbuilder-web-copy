$(document).ready(function() {
    ...
    $('#add_front_application').mousedown(function() {
        ...
        var delete_application      = '<a href="#" class="btn btn-xs btn-flat btn-primary save_app_row_template" ><span class="glyphicon glyphicon-save"></span> Save Row Template</a> <a class="btn btn-flat btn-xs btn-danger delete-application" style="display: block; margin-top: 5px;" data-id="' + canvasFront.getObjects().indexOf(group) + '">Delete</a>';
