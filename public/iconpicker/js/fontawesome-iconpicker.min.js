...
$('body').on('click', '#change-icon', function() {
    ...
    $('#demo-icon').removeClass();
    $('#demo-icon').addClass(icons[selectedIcon].icon);
    $('#icon-field').val(icons[selectedIcon].icon);
});
