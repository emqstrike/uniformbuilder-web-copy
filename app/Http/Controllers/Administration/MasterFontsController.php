...
use App\APIClients\MasterFontsAPIClient as APIClient;

class MasterFontsController extends Controller
{
    protected $client;
    ...
    public function index()
    {
        ...
        if (in_array($user_id, $su_array)) {
            return view('administration.master-pages.master-fonts', [
                'fonts' => $fonts,
                'sports' => $sports
                ]);
        }
