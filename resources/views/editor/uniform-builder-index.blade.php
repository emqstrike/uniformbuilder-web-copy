...
@section('right-pane')
    ...
    <div id="property-modifiers-menu" class="hidden">
        ...
        <a href="#" class="group-pane tippy-menu-item group-4 menu-item-pippings" data-tippy-content="PIPINGS">4</a>
        ...
        <a href="#" class="group-pane tippy-menu-item group-8 menu-item-logo" data-tippy-content="LOGO">8</a>
    </div>
