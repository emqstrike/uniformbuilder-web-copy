<!-- Application UI Block - LETTERS -->
    ...
    <script type="text/mustache" id="add-new-application-letters">
        ...
        <h5 uk-margin class="uk-margin-remove-top uk-margin-small-bottom uk-text-uppercase uk-text-bold fc-darker abrade-ultra-italic">@{{ type }}</h5>

        <div class="uk-grid-small grid-tiny uk-grid-match uk-text-center con-toggle" uk-grid>
            <div class="uk-width-1-2 ">
                <button class="toggle-decor-letter uk-button uk-button-small uk-width-1-1 uk-button-default uk-text-capitalize uk-text-capitalize btn-selection-choice toggle-show" type="button" uk-toggle="target:.toggle-decor-letter; cls: uk-active">
...
<script type="text/mustache" id="m-add-new-application">
    <div class="toggle-decor-letter con-add-application uk-active">
        ...
        <div class="con-input-object con-en-disable-me">
            <h6 class="uk-text-small uk-text-uppercase uk-text-bold uk-margin-top uk-margin-small-bottom abrade-black">Input team name</h6>
            <div class="">
                <input class="en-disable-me uk-input bgc-light bdr-lightGray" type="text" placeholder="Your team name">
            </div>
        </div>
    </div>
</script>
