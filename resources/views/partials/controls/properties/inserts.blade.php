...
<div class="cp-padding-medium uk-padding-remove-bottom" id="primary_options_colors">
    <ul style="list-style:none; padding: 0 !important" class="insert-container">
        @{{ #inserts }}
            ...
            <div class="modal-body cp-padding-remove-horizontal">
                <div class="row">
                    <div class="col-md-3 cp-padding-remove-right">
                        ...
                        <div>
                            <p class="cp-text-center cp-text-uppercase cp-text-small cp-width-1-1 cp-text-bold cp-margin-small modal-pattern-name"></p>
                        </div>
                    </div>
