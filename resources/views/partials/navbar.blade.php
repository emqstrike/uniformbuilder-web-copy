        ...
        <div class="navbar-header btn-group" id="navbar-header">
            <a class="navbar-brand btn dropdown-toggle" data-toggle="dropdown" href="/"><img src="/images/branding/pl-logo-black-1e1e1e.png" height="50em"></a>
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="https://www.prolook.com" target="_new"><i class="fa fa-globe" aria-hidden="true"></i> Official Prolook Website</a></li>
                    <li><a href="https://blog.prolook.com/" target="_new"><i class="fa fa-newspaper-o" aria-hidden="true"></i> Prolook Blog</a></li>
                    <li><a href="https://www.prolook.com/contact/" target="_new"><i class="fa fa-envelope-o" aria-hidden="true"></i> Contact Us</a></li>
