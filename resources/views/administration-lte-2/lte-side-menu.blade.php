    ...
    <section class="sidebar">
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/administration/{{ env('ENDPOINT_VERSION') }}/feedbacks"><i class="fa fa-comments"></i> Feedbacks<span class="pull-right-container"><small class="label pull-right bg-green"><i class="fa fa-exclamation"></i></small></span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="/administration/{{ env('ENDPOINT_VERSION') }}/points_of_measures"><i class="fa fa-arrows"></i> Points of Measures<span class="pull-right-container"><small class="label pull-right bg-green"><i class="fa fa-exclamation"></i></small></span></a></li>
            <li><a href="/administration/{{ env('ENDPOINT_VERSION') }}/spec_sheets"><i class="fa fa-info"></i> Spec Sheets<span class="pull-right-container"><small class="label pull-right bg-green"><i class="fa fa-exclamation"></i></small></span></a></li>
          </ul>
        </li>
         <li class="treeview">
          <a href="#">
