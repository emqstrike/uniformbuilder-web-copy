            ...
            <div class="modal-body">
                ...
                <form id="myForm" role="form" action="#" method="POST">
                  <div class="form-group">
                    <label>Code</label>
                      <input type="text" class="form-control input-code" placeholder="Enter code" required>
                  </div>
                  <div class="form-group">
                    <label>Brand</label>
                      <select class="form-control input-brand-id" required>
                  ...
                  <div class="form-group">
                    <label>Name</label>
                      <input type="text" class="form-control input-name" placeholder="Fabric Name" required>
                  </div>
                  <div class="form-group">
                    <label>Factory</label>
