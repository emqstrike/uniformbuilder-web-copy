    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><b>Edit Colors Set</b></div>
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="/administration/v1-0/colors_set/update" enctype="multipart/form-data" id='create-color-form'>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary create-color btn-flat">
                                    Update Record
                                </button>
                                <a href="/administration/v1-0/colors_sets" class="btn btn-danger btn-flat">
                                    Cancel
                                </a>
                            </div>
                        </div>
