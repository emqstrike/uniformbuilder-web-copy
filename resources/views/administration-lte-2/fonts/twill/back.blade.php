<h4>
    ...
    <button class="btn btn-flat btn-xs btn-primary add-font-size" @click.prevent="addTwillLayer('back')">
...
<table class="table table-bordered table-striped">
    ...
    <tbody v-for="data in font.font_size_tables.filter(obj => { return obj.perspective === 'back' })">
        <tr v-for="(fontData, index) in data.sizes">
            ...
            <td>
                <button class="btn btn-sm btn-flat btn-danger" @click.prevent="removeTwillLayer(index, 'back')">Remove</button>
            </td>
        </tr>
    </tbody>
</table>