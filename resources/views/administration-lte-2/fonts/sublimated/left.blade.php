<h4>
    ...
    <button class="btn btn-flat btn-xs btn-primary add-font-size" @click.prevent="addSublimatedLayer('left')">
...
<table class="table table-bordered table-striped">
    ...
    <tbody v-for="data in font.sublimated_font_size_tables.filter(obj => { return obj.perspective === 'left' })">
        <tr v-for="(fontData, index) in data.sizes">
            ...
            <td>
                <button class="btn btn-sm btn-flat btn-danger" @click.prevent="removeSublimatedLayer(index, 'left')">Remove</button>
            </td>
        </tr>
    </tbody>
</table>