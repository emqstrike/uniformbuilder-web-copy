    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-info">
                <div class="panel-heading">Add New {{ ucfirst($cut_type) }}</div>
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="/administration/cut/add" enctype="multipart/form-data" id='create-pattern-form'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="name" class="form-control cut-style-name" name="name" value="{{ old('name') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="name" class="form-control cut-style-code" name="code" value="{{ old('code') }}">
                            </div>
                        </div>
