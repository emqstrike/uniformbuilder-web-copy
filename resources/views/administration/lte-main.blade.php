...
<title>Administration | {{ config('customizer.vendor.title') }}</title>
    ...
    <header class="main-header">
        <a href="#" class="logo">
            <span class="logo-mini">
                <img src="{{ config('customizer.vendor.logo_url') }}" height='20em'>
            </span>
            <span class="logo-lg">
                <img src="{{ config('customizer.vendor.logo_url') }}" height='35em'>
            </span>
        </a>
