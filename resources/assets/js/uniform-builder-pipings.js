$(document).ready(function () {
    ...
    ub.funcs.processPipings = function () {
        ...
        if (!(ub.funcs.isCurrentSport('Baseball') || ub.funcs.isCurrentSport('Fastpitch') || ub.funcs.isSocks() || _.contains(ub.data.riddellSportWithPipings, ub.config.sport) )) { return; }
