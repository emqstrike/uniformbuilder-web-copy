...
RichardsonSkin.funcs = {
    ...
    setupRightPanelHeader: function() {
        ...
        var data = {
            ...
            "block_pattern": typeof ub.current_material.material.model_number !== "undefined" && ub.current_material.material.model_number !== "" ? ub.current_material.material.model_number + "-L": this.richardsonPTSCategory(),
